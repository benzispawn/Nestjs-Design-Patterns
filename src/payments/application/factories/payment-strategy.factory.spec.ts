...
import type { BoletoPaymentStrategy } from '../../infra/strategies/boleto-payment.strategy';
import type { CreditCardPaymentStrategy } from '../../infra/strategies/credit-card-payment.strategy';
import type { PixPaymentStrategy } from '../../infra/strategies/pix-payment.strategy';
...
describe('PaymentStrategyFactory', () => {
  ...
  it('should throw an error', () => {
    expect(() => factory.create(undefined as unknown as PaymentMethod)).toThrow(
